...
SENT2VEC_IN="./resources/sent2vec_unigram.txt"
SENT2VEC_OUT="./resources/sent2vec_unigram_filtered_${DATA_NAME}.txt"
...
~/anaconda3/bin/python src/preprocessing/filter_emb.py -f $OUTPUT_DIR/dictionary_index -e $SENT2VEC_IN -o $SENT2VEC_OUT
