...
parser.add_argument('--data', type=str, default='/iesl/canvas/hanqingli/NSD_for_sentence_embedding/data/wiki2016_min100/',
                    help='location of the data corpus')
parser.add_argument('--save', type=str, default='/iesl/canvas/hanqingli/NSD_for_sentence_embedding/data/wiki2016_min100/tensors/',
...
parser.add_argument('--max_target_num', type=int, default=50,
...
parser.add_argument('--target_num_prev', type=int, default=3,
                    help='Number of sentences considered before the feature sentence')
parser.add_argument('--target_num_next', type=int, default=2,
                    help='Number of sentences considered after the feature sentence')

parser.add_argument('--seed', type=int, default=1111,
                    help='random seed')

parser.add_argument('--stop_word_file', type=str, default='/iesl/canvas/hanqingli/NSD_for_sentence_embedding/data/stop_word_list',
...
corpus_input_name = args.data
dictionary_input_name = "/iesl/canvas/hanqingli/NSD_for_sentence_embedding/data/wiki2016_min100/dictionary_index"
...
summarize_output_name = os.path.join(args.save, "summarize.txt")
